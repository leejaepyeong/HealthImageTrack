...
{
	AsyncConversion_t1B3B9B398D763F0F12781993336A2E048C86E787 * _thisAdjusted;
	int32_t _offset = 1;
	_thisAdjusted = reinterpret_cast<AsyncConversion_t1B3B9B398D763F0F12781993336A2E048C86E787 *>(__this + _offset);
...
IL_000c:
	{
		...
		NullCheck(G_B2_0);
		int32_t L_3;
		L_3 = VirtualFuncInvoker1< int32_t, int32_t >::Invoke(13 /* UnityEngine.XR.ARSubsystems.XRCpuImage/AsyncConversionStatus UnityEngine.XR.ARSubsystems.XRCpuImage/Api::GetAsyncRequestStatus(System.Int32) */, G_B2_0, L_2);
		return L_3;
	}
}
...
{
	{
		...
		NullCheck(L_1);
		int32_t L_4;
		L_4 = VirtualFuncInvoker2< int32_t, int32_t, ConversionParams_t3DDB9752BA823641A302D0783C14048D9B09B74A  >::Invoke(7 /* System.Int32 UnityEngine.XR.ARSubsystems.XRCpuImage/Api::ConvertAsync(System.Int32,UnityEngine.XR.ARSubsystems.XRCpuImage/ConversionParams) */, L_1, L_2, L_3);
...
IL_0011:
	{
		...
		NullCheck(L_2);
		VirtualActionInvoker1< int32_t >::Invoke(12 /* System.Void UnityEngine.XR.ARSubsystems.XRCpuImage/Api::DisposeAsyncRequest(System.Int32) */, L_2, L_3);
		// m_Api = null;
...
{
	Cinfo_t04039019CC240855A566C51C5F0DD8D0D6440E9F * _thisAdjusted;
	int32_t _offset = 1;
	_thisAdjusted = reinterpret_cast<Cinfo_t04039019CC240855A566C51C5F0DD8D0D6440E9F *>(__this + _offset);
	String_t* _returnValue;
